...
int main()
{
    ...
    insert_node("folderx", 1, 0);
    insert_node("folderx/file1.txt", 1, 1);
    insert_node("folderx/folderxx", 1, 0);
    insert_node("folderx/folderxx/file.txt", 1, 1);
    insert_node("foldery", 1, 0);
    insert_node("foldery/file2.txt", 1, 1);
    insert_node("file3", 1, 1);
    insert_node("folder1", 2, 0);
    insert_node("folder1/anime.txt", 2, 1);
    insert_node("folder2", 2, 0);
    insert_node("folder2/study.txt", 2, 1);
    ...
    snprintf(argscmd_buffer, MAX_BUFFER_SIZE, "$%d", SS_number);
